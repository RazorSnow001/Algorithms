...
public class MergeSort implements Sort {
    ...
    public int[] mergeSort(int[] array,int beginIndex,int endIndex){
         ...
         int[] sortedFirstHalf = mergeSort(array,beginIndex,beginIndex+middleIndex);
         int[] sortedLastHalf = mergeSort(array,beginIndex+middleIndex+1,endIndex);
         combinationOfSortedArrays(resultArray,sortedFirstHalf,sortedLastHalf);
         return resultArray;
    }

    private void combinationOfSortedArrays(int[] resultArray,int[]sortedFirstHalf,int[] sortedLastHalf){
        int i =0;
        int j = 0;
        int k = 0;
